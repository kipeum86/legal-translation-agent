...
1. Prefer `.claude/scripts/translate-job.py resume --job-id <job_id> --dry-run`
   to validate checkpoint/manifest state and artifact checksums.
2. Check for `output/working/checkpoint.json`
